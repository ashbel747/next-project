...
export interface AuthorType {
  _id: string;       // IDs are usually strings in Sanity
  name: string;
  image?: string;    // optional because some authors may not have an image
}

export interface StartupCardType {
  _id: string;               // Post ID
  _createdAt: string;        // Sanity returns this as an ISO string
  views: number;
  author: AuthorType;        // nested type
  title: string;
